import{a as E,S as b,i as d}from"./assets/vendor-2cfd16ce.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();async function m(t,r){const o="43131221-437eb08730a4aa4be76ca14ef",i="https://pixabay.com/api/",e={key:o,q:t,image_type:"photo",orientation:"horizontal",page:r,per_page:15,safesearch:!0};return(await E.get(i,{params:e})).data}function w(t){const{largeImageURL:r,webformatURL:o,tags:i,likes:e,views:s,comments:l,downloads:_}=t;return`<li class="gallery-item">
